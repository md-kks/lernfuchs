...
class LernFuchsWorldGame extends FlameGame {
  ...
  static final questNodes = [
    ...
    WorldQuestNode(
      ...
      label: 'Singende Blätter',
      questId: 'chapter1_singende_blaetter',
      storyText:
          'Die Blätter rauschen im Silbentakt. Höre genau hin und klatsche leise mit.',
      order: 2,
      subtitle: 'Kapitel 1: Silben',
    ),
    WorldQuestNode(
      id: 'lichtung',
      ...
      label: 'Erste Lichtung',
      questId: 'chapter1_erste_lichtung',
      storyText:
          'Auf der ersten Lichtung funkeln Sternpunkte. Zähle ruhig bis zwanzig weiter.',
      order: 3,
      subtitle: 'Kapitel 1: Zahlen bis 20',
    ),
    WorldQuestNode(
      id: 'chapter2_alter_baum',
      mapPosition: WorldMapBackground.nodePositions[4],
      state: QuestNodeState.lockedFar,
      type: QuestNodeType.tree,
      label: 'Alter Baum',
      questId: 'chapter2_alter_baum',
      storyText:
          'Die Jahresringe leuchten in Paaren. Lege kleine Zahlen zusammen.',
      order: 4,
      subtitle: 'Kapitel 2: Addition bis 10',
    ),
    WorldQuestNode(
      id: 'chapter2_nebelbruecke',
      mapPosition: WorldMapBackground.nodePositions[5],
      state: QuestNodeState.lockedFar,
      type: QuestNodeType.bridge,
      label: 'Nebelbrücke',
      questId: 'chapter2_nebelbruecke',
      storyText:
          'Ein paar Lichtplanken verschwinden. Schau, was uebrig bleibt.',
      order: 5,
      subtitle: 'Kapitel 2: Subtraktion bis 10',
    ),
    WorldQuestNode(
      id: 'chapter2_mauer_der_funken',
      mapPosition: WorldMapBackground.nodePositions[6],
      state: QuestNodeState.lockedFar,
      type: QuestNodeType.clearing,
      label: 'Mauer der Funken',
      questId: 'chapter2_mauer_der_funken',
      storyText:
          'Funkensteine bauen eine Zahlenmauer. Zwei untere Steine helfen dem oberen.',
      order: 6,
      subtitle: 'Kapitel 2: Zahlenmauern',
    ),
    WorldQuestNode(
      id: 'chapter2_wegweiser_aus_klang',
      mapPosition: WorldMapBackground.nodePositions[7],
      state: QuestNodeState.lockedFar,
