...
### F. TFLite-Handschrifterkennung (Fortgeschritten)
*   **ML-Service (`TFLiteService`):** Vollständige Preprocessing-Pipeline (Strokes -> 28x28 Tensor) implementiert.
*   **Verbessertes Widget:** Das `HandwritingWidget` nutzt nun buchstaben-spezifische Target-Grids für Vokale (A, E, I, O, U) zur genaueren Formprüfung.

---

## 2. Noch ausstehende oder unvollständige Punkte

### A. TFLite Modell & Inferenz
*   **Status:** Preprocessing und Heuristiken bereit, physisches Modell fehlt.
*   **Was fehlt:** Einbindung der `handwriting.tflite` Datei und Verknüpfung der Inferenz-Logik im Service.
